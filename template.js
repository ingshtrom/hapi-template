...
(function() {
  ...
  module.exports.template = function(grunt, init, done) {
    init.process({type: 'node'}, [
      ...
      init.prompt('author_name', 'Alex "Ingshtrom" Hokanson'),
      init.prompt('author_email', 'alex.hokanson@mysticgear.com'),
      init.prompt('author_url', 'https://github.com/ingshtrom'),
      init.prompt('node_version', '>= 0.11.0'),
      init.prompt('main', 'server.js'),
